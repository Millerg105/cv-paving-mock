...
export default function OverallGalleryPage() {
            ...
            <div className="pt-32 pb-16 px-6 md:px-12 flex-grow max-w-[1400px] mx-auto w-full">
                <div className="text-center mb-16">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-4">
                        <Link href="/gallery" className="px-6 py-2 rounded-full border border-primary text-primary uppercase text-sm tracking-widest font-bold">
                            All Projects
                        </Link>
                ...
                <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 space-y-4">
                    {galleryImages.map((src, i) => (
                        <div key={i} className="relative w-full break-inside-avoid rounded-xl overflow-hidden group shadow-lg border border-white/10">
                            <Image
                                src={src}
